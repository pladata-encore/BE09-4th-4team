            ...
            const fetchDashboardStats = {
                "DashboardPage.useEffect.fetchDashboardStats": async ()=>{
                    try {
                        ...
                        const dataWithIcons = res.data.map({
                            "DashboardPage.useEffect.fetchDashboardStats.dataWithIcons": (stat)=>({
                                    ...stat,
                                    icon: getIconByType(stat.type)
                                })
                        }["DashboardPage.useEffect.fetchDashboardStats.dataWithIcons"]);
...
_s(DashboardPage, "v8CgubmSM2gMv9IaswcR3HwSX1E=", false, function() {
    return [
