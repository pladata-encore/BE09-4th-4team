        ...
        "NewProductModal.useEffect": ()=>{
            const fetchBrands = {
                "NewProductModal.useEffect.fetchBrands": async ()=>{
                    try {
                        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("http://localhost:8080/admin/brands");
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                            ...
                            children: [
                                ...
                                brandList.filter((brand)=>brand && brand.brand_id !== undefined).map((brand)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                    ...
                    try {
                        ...
                        const mappedData = data.map({
                            "ProductsPage.useEffect.fetchProducts.mappedData": (p)=>({
                                    ...
                                    stock: p.stock,
                                    price: "₩ ".concat(p.discountedPrice ? p.discountedPrice.toLocaleString() : '0'),
                                    status: p.state,
        ...
        try {
            ...
            const response = await fetch('/api/products', {
                ...
                body: JSON.stringify({
                    ...
                    description: (_newProduct_description = newProduct.description) !== null && _newProduct_description !== void 0 ? _newProduct_description : '',
